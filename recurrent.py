...
class NSNPAU(Recurrent):
    ...
    def build(self, input_shape):
        ...
        if self.use_bias:
            ...
            self.bias_a = None
        self.built = True
        self.reset_gate_peephole_weights = self.add_weight((self.units,),
                                                           name='reset_gate_peephole_weights',
                                                           initializer=self.kernel_initializer)
        self.consume_gate_peephole_weights = self.add_weight((self.units,),
                                                            name='consume_gate_peephole_weights',
                                                            initializer=self.kernel_initializer)
        self.output_gate_peephole_weights = self.add_weight((self.units,),
